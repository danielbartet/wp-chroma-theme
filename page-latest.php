				...
				<div id="home-left-col" class="relative">
					...
					<div id="home-mid-wrap" class="left relative">
						<div id="archive-list-wrap" class="left relative">
							...
							<?php } ?>
								<?php $mvp_posts_num = esc_html(get_option('mvp_posts_num')); $paged = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts(array( 'posts_per_page' => $mvp_posts_num&offset=4, 'paged' => $paged )); if (have_posts()) : while (have_posts()) : the_post(); ?>
									<li class="infinite-post">
										...
										<div class="archive-list-out">
											<div class="archive-list-img left relative">
												...
												<?php $post_views = get_post_meta($post->ID, "post_views", true); if ( $post_views >= 1) { ?>
